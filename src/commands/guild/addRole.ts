    ...
    async execute(client, interaction) {
        ...
        if (sub === 'usuario') {
            ...
            for (const [, member] of members) {
                ...
                if (member.roles.cache.has(role.id)) { omitidos++; continue } // Ya tiene el rol
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Asignados', value: `${asignados}`, inline: true },
                    { name: 'Ya tenían el rol', value: `${omitidos}`, inline: true },
